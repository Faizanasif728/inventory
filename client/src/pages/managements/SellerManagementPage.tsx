import { ArrowLeftOutlined, DeleteFilled, EditFilled, PlusOutlined } from '@ant-design/icons';
...
import CreateSellerModal from '../../components/modal/CreateSellerModal';
  ...
  return (
    <>
      <div style={{ padding: '0 clamp(0.5rem, 2vw, 1rem)', marginBottom: '.75rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <h1 style={{ color: '#4F0341', fontWeight: 900, fontSize: 'clamp(1.25rem, 4vw, 1.75rem)', letterSpacing: '.04em', textTransform: 'uppercase', margin: 0 }}>Manage Sellers</h1>
      ...
      <CreateSellerModal openModal={isCreateSellerOpen} setOpenModal={setIsCreateSellerOpen} />
    </>
  );
};
